...
@NamedNativeQuery(
        ...
        query = "select tp.* from ticket_prices tp " +
                ...
                "left join pricing_categories pc on tp.category_code = pc.category_code " +
                "where tt.includes_workshop = true and pc.category_name = :name",
...
public class TicketPrice {
    ...
    @ManyToOne
    @JoinColumn(name = "category_code", nullable = false, updatable = false)
